...
- psm.tsv (PSM reports from [Step 4i](#4i-generate-reports))
...
- psm.tsv (plex-specific PSM reports, output from [Step 4i](#4i-generate-reports))
...
- **nonimputed_matrix_{level}_GLProteomics.csv** (feature table and sample quantification columns from abundance_protein_MD.tsv, abundance_gene_MD.tsv, or abundance_peptide_MD.tsv, before imputation. NAs where the feature was not detected.)
