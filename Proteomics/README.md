...
* [**Pipeline_GL-DPPD-[LFQ-MBR]_Versions**](Pipeline_GL-DPPD-[LFQ-MBR]_Versions)

  - Contains the current and previous GeneLab Proteomics processing pipeline versions documentation for LFQ-MBR workflow

* [**Pipeline_GL-DPPD-[TMT10]_Versions**](Pipeline_GL-DPPD-[TMT10]_Versions)

  - Contains the current and previous GeneLab Proteomics processing pipeline versions documentation for TMT10 workflow

* [**Pipeline_GL-DPPD-[TMT16]_Versions**](Pipeline_GL-DPPD-[TMT16]_Versions)

  - Contains the current and previous GeneLab Proteomics processing pipeline versions documentation for TMT16 workflow

* [**Pipeline_GL-DPPD-[TMT16-phospho]_Versions**](Pipeline_GL-DPPD-[TMT16-phospho]_Versions)

  - Contains the current and previous GeneLab Proteomics processing pipeline versions documentation for TMT16-phospho workflow
...
Licenses for the 3rd party open source software utilized in the Proteomics pipeline and workflow can be found in the [3rd_Party_Licenses sub-directory](Workflow_Documentation/NF_Proteomics/License/3rd_Party_Licenses/README.md). 
