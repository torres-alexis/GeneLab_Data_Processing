...
params:
    ...
    cpus: 1
    technical_replicates_path: NULL
---
...
dds_1 <- tryCatch(
    expr = {
        DESeq2::estimateSizeFactors(dds_1, controlGenes = ercc_rows_gpB)
    },
    error = function(e) {
        DESeq2::estimateSizeFactors(dds_1, type = "poscounts", controlGenes = ercc_rows_gpB)
    }
)
...
dds_1 <- DESeq2::estimateDispersions(dds_1)
dds_1 <- DESeq2::nbinomWaldTest(dds_1,)
```
