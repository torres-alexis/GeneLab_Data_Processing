...
params:
    ...
    microbes: FALSE # Set this to true to use Bowtie2 inputs
---
...
output_file_name <- if (params$microbes) {
...
write.csv(
    txi.rsem$counts,
    file = paste0(params$normalized_counts_output_prefix, output_file_name)
    )
write.csv(
    normCounts,
