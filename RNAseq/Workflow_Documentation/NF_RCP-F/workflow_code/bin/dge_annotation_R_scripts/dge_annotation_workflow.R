...
parser <- add_option(parser, c("--technical_replicates_path"),
    help = "Path to the technical replicates file",
...
if (!args$skip_perform_dge) {
    ...
    rmarkdown::render(here("dge_annotation_R_scripts", "Perform_DGE.Rmd"),
        ...
        params = list(
            ...
            cpus = args$cpus,
            technical_replicates_path = args$technical_replicates_path
        )
    )
