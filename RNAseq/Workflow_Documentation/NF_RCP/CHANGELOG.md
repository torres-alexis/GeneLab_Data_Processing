...
## [2.0.2](https://github.com/nasa/GeneLab_Data_Processing/tree/NF_RCP_2.0.2/RNAseq/Workflow_Documentation/NF_RCP) - 2025-07-14
...
- Fixed issues with annotation file download by adding user-agent header
